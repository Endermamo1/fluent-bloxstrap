> [!CAUTION]
> The only official places to download Bloxstrap are GitHub repository[](https://github.com/pizzaboxer/bloxstrap/releases) and [bloxstrap.pizzaboxer.xyz](https://bloxstrap.pizzaboxer.xyz). Any other websites offering downloads or claiming to be us are not controlled by us.
